...
╠═〘 Riel Botz 〙 ═`.trim(), 'RielXzy', 'Pemilik\nBot', '#owner', 'Ga jadi deh..', 'gajadi', m)
}
...
if (new Date() * 1 - setting.status > 1000) {
        ...
        await this.setStatus(`⏲️ 𝖱𝗎𝗇𝗍𝗂𝗆𝖾: ${uptime} | 🛰 𝖬𝗈𝖽𝖾: ${global.opts['self'] ? '𝖯𝗋𝗂𝗏𝖺𝗍𝖾' : setting.groupOnly ? 'Hanya Grup' : '𝖯𝗎𝖻𝗅𝗂𝖼'} | Rɪᴇʟʙᴏᴛᴢ 𝖻𝗒 Rɪᴇʟ𖣘`).catch(_ => _)
